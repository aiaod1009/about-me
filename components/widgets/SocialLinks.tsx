...
export default function SocialLinks({ onSwitchBg }: Props) {
  return (
    <div className="flex items-center justify-center gap-2.5">
      {/* Github */}
      <a
        href="https://github.com/aiaod1009"
        target="_blank"
        rel="noopener noreferrer"
        className="bg-gray-900 hover:bg-gray-800 text-white text-[13px] px-4 py-2 rounded-xl flex items-center gap-1.5 transition-colors cursor-pointer shadow-sm"
      >
